    ...
    render() {
        return (
            <div class="OverworldScreen">
                ...
                <div class="Status">
                    <span class="Label">Name:</span> {App.player.name || "Adventurer"} | <span class="Label">Level:</span> {App.player.level} | {App.player.position.x}x{App.player.position.y} | {App.player.health}/{App.player.maxhealth}hp <span class="HealthBar"><span class="Fill" style={{"width": ((App.player.health / App.player.maxhealth)) * 100 + "%"}}/></span>
                </div>
                <div class="Content">
                    <div class="World">
                        {this.terrain}
